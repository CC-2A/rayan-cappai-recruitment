...
const translations = {
  en: {
    meta: {
      ...
      description:
        "Official recruitment profile for Rayan Cappai, a 2006 French central midfielder (6/8/10) currently playing in Norway with Nybergsund IL Trysil and under contract until 31 October 2026.",
    },
    a11y: {
    ...
    profile: {
      ...
      card3Label: "Current club",
      card3Value: "Nybergsund IL Trysil · Norway",
      card4Label: "Current competition",
    ...
    career: {
      ...
      title: "A clear pathway across France, the U.S. and Norway.",
      ...
      step3Date: "Summer 2026 · United States",
      step3Title: "First State FC",
      step3Copy:
        "The League for Clubs, Northeast Conference. Recent match footage available.",
      step4Date: "2026 · Current club in Norway",
      step4Title: "Nybergsund IL Trysil",
      step4Copy:
  ...
  fr: {
    meta: {
      ...
      description:
        "Profil officiel de recrutement de Rayan Cappai, milieu central français 2006 (6/8/10), actuellement joueur de Nybergsund IL Trysil en Norvège et sous contrat jusqu’au 31 octobre 2026.",
    },
    a11y: {
    ...
    profile: {
      ...
      card3Label: "Club actuel",
      card3Value: "Nybergsund IL Trysil · Norvège",
      card4Label: "Compétition actuelle",
      card4Value: "4. divisjon menn · 2026",
    ...
    career: {
      ...
      title: "Un parcours clair entre la France, les États-Unis et la Norvège.",
  ...
  es: {
    meta: {
      ...
      description:
        "Perfil oficial de reclutamiento de Rayan Cappai, mediocampista central francés 2006 (6/8/10), actualmente jugador del Nybergsund IL Trysil en Noruega y con contrato hasta el 31 de octubre de 2026.",
    },
    a11y: {
    ...
    profile: {
      ...
      card3Label: "Club actual",
      card3Value: "Nybergsund IL Trysil · Noruega",
      card4Label: "Competición actual",
      card4Value: "4. divisjon menn · 2026",
    ...
    career: {
      ...
      title: "Un recorrido claro entre Francia, EE. UU. y Noruega.",
