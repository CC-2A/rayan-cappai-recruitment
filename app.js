...
const translations = {
  fr: {
    ...
    text: {
      ...
      'Profile': 'Profil',
      'Sport CV': 'CV sportif',
      'A fast coach review page: highlights, two full matches, Sport CV downloads, and direct contact.': 'Page de revue rapide pour coachs : highlights, deux matchs complets, téléchargements du CV sportif et contact direct.',
      'Quick Snapshot': 'Aperçu rapide',
      'Essential facts': 'Faits essentiels',
      'One scan for role, pathway, and timing.': 'Un seul aperçu pour le rôle, le parcours et la disponibilité.',
      'Current Pathway': 'Parcours actuel',
      'Central Midfielder · 6 / 8 / 10': 'Milieu central · 6 / 8 / 10',
      'First State FC / Midnight Riders · U.S. Summer League starter': 'First State FC / Midnight Riders · Titulaire en U.S. Summer League',
      'College Background': 'Parcours universitaire',
      'Available': 'Disponible',
      'Start with highlights, then use the two full matches for decisions, positioning, and tempo.': 'Commencez par les highlights, puis utilisez les deux matchs complets pour les décisions, le positionnement et le tempo.',
      'Quick first look at technical quality, movement, and ball security.': 'Premier aperçu rapide de la qualité technique, du mouvement et de la sécurité avec le ballon.',
      ...
      'Right-footed midfielder who protects possession, connects phases, and changes height when the game asks for it.': 'Milieu droitier qui protège la possession, relie les phases et ajuste sa hauteur selon les besoins du match.',
      'What coaches should review': 'Ce que les coachs doivent évaluer',
      'Clean connector who can receive under pressure and move the game forward.': 'Relais propre capable de recevoir sous pression et de faire avancer le jeu.',
      'Full-match video shows scanning, tempo control, and defensive responsibility.': 'Les matchs complets montrent la prise d’information, le contrôle du tempo et la responsabilité défensive.',
      'Use the Sport CV only for background details after the video review.': 'Utilisez le CV sportif uniquement pour les détails de parcours après la revue vidéo.',
      ...
      'Programs that value possession security and midfield connection.': 'Programmes qui valorisent la sécurité en possession et la connexion au milieu.',
      'Staffs that evaluate players through complete match footage.': 'Staffs qui évaluent les joueurs avec des matchs complets.',
      'Environments needing a coachable, adaptable central midfielder.': 'Environnements recherchant un milieu central coachable et adaptable.',
      'For recruitment, evaluation, or next steps, contact Rayan directly.': 'Pour le recrutement, l’évaluation ou les prochaines étapes, contactez directement Rayan.',
      'Recruitment profile · French midfielder · United States': 'Profil de recrutement · Milieu français · États-Unis',
      ...
      'Coach-ready video': 'Vidéo prête pour coachs',
  ...
  es: {
    ...
    text: {
      ...
      'A fast coach review page: highlights, two full matches, Sport CV downloads, and direct contact.': 'Página rápida para entrenadores: highlights, dos partidos completos, descargas del CV deportivo y contacto directo.',
      'Quick Snapshot': 'Resumen rápido',
      'Essential facts': 'Datos esenciales',
      'One scan for role, pathway, and timing.': 'Un vistazo para rol, trayectoria y disponibilidad.',
      'Current Pathway': 'Trayectoria actual',
      'Central Midfielder · 6 / 8 / 10': 'Mediocampista central · 6 / 8 / 10',
      'First State FC / Midnight Riders · U.S. Summer League starter': 'First State FC / Midnight Riders · Titular en U.S. Summer League',
      'College Background': 'Trayectoria universitaria',
      'Available': 'Disponible',
      'Start with highlights, then use the two full matches for decisions, positioning, and tempo.': 'Empiece con los highlights y use los dos partidos completos para decisiones, posicionamiento y ritmo.',
      'Quick first look at technical quality, movement, and ball security.': 'Primer vistazo rápido a calidad técnica, movimiento y seguridad con balón.',
      ...
      'Right-footed midfielder who protects possession, connects phases, and changes height when the game asks for it.': 'Mediocampista diestro que protege la posesión, conecta fases y cambia altura cuando el partido lo requiere.',
      'What coaches should review': 'Qué deben revisar los entrenadores',
      'Clean connector who can receive under pressure and move the game forward.': 'Conector limpio que puede recibir bajo presión y hacer avanzar el juego.',
      'Full-match video shows scanning, tempo control, and defensive responsibility.': 'Los partidos completos muestran lectura previa, control del ritmo y responsabilidad defensiva.',
      'Use the Sport CV only for background details after the video review.': 'Use el CV deportivo solo para detalles de trayectoria después de revisar el video.',
      'Download the CV in the preferred language.': 'Descargue el CV en el idioma preferido.',
      'Action photos remain available for visual context.': 'Las fotos de acción siguen disponibles como contexto visual.',
      'Supporting documents': 'Documentos de apoyo',
      'Academic, eligibility, and reference documents are available by email request.': 'Documentos académicos, de elegibilidad y referencias disponibles por solicitud por email.',
      'Programs that value possession security and midfield connection.': 'Programas que valoran seguridad en posesión y conexión en el mediocampo.',
      'Staffs that evaluate players through complete match footage.': 'Staffs que evalúan jugadores con partidos completos.',
      'Environments needing a coachable, adaptable central midfielder.': 'Entornos que necesitan un mediocampista central adaptable y receptivo al coaching.',
      'For recruitment, evaluation, or next steps, contact Rayan directly.': 'Para reclutamiento, evaluación o próximos pasos, contacte directamente a Rayan.',
      'Recruitment profile · French midfielder · United States': 'Perfil de reclutamiento · Mediocampista francés · Estados Unidos',
      ...
      'Coach-ready video': 'Video listo para entrenadores',
